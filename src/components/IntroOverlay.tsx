      ...
      {show && (
        ...
        >
          ...
          >
            ...
            <h1 className="mt-6 font-display text-5xl leading-[1.05] text-white text-balance sm:text-6xl">
              {siteCopy.title}
            </h1>
            ...
            <div className="mt-10 flex flex-col items-center gap-3">
              <button
                type="button"
                onClick={onDismiss}
                className="group inline-flex items-center gap-3 rounded-full border border-white/20 bg-white/5 px-6 py-3 text-sm uppercase tracking-[0.2em] text-white/85 backdrop-blur transition hover:border-white/40 hover:bg-white/10 hover:text-white"
              >
